// Correção dos exercícios da aula 04 da etapa 01
/*
...
const my3FavoriteTVShows = ["Breaking bad", "TBBT", "Ozark"];
...
const validation = typeSentence.length > 39;

// console.log(`A string que a "typeSentence" armazena tem mais de 39
// caracteres? ${String(validation).slice(0, 1).toLocaleUpperCase()}${String(
//   validation
// ).slice(1)}.`);
